...
t.longname = "Allows you to edit scripts externally from VED."  -- This can be about twice as long
...
t.description = [[
Syncs VED scripts to external files, allowing them to be edited with your text editor of choice.

Scripts are synced any time a project is loaded or saved (favouring external script files), and individual scripts are updated when opened in the VED editor.
